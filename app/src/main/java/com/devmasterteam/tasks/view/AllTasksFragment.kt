    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, b: Bundle?): View {
        ...
        val listener = object : TaskListener{
            override fun onListClick(id: Int) {
                ...
                val bundle = Bundle()// Bundle é um conjunto de informacoes
                bundle.putInt(TaskConstants.BUNDLE.TASKID, id)
                intent.putExtras(bundle)// Quando eu passo o bundle para dentro da intent as
                // informações do objeto selecionado são enviados para a activity
